...
document.getElementById("menu").innerHTML = "<div class=\"ayatBox\">I seek protection for ALLAH from accursed devil<br><br>In the Name for ALLAH the Most Beneficent, the Most Merciful</div><br><a href=\"" + site + "index.html\" class=\"button skyBlueButton\">Home</a> <a href=\""+site+"quran.html\" class=\"button skyBlueButton\">Quran</a> <a href=\""+site+"translator.html\" class=\"button skyBlueButton\">Translator</a><form action=\"javascript:searchAyat()\">Search by letters in Quran <input type=\"text\" id=\"searchAyat\" minlength=\"3\" maxlength=\"45\" value=\"\" required> &nbsp;<input class=\"icon\" type=\"image\" src=\"" + site + "img/search.png\" alt=\"Search\"></form>" + quranMenu + quranMenu2 + translatorMenu + "<div id=\"ayat\"></div><div id=\"surah\"></div><div id=\"surahPage\"></div><div id=\"islam\"></div><div id=\"islamPage\"></div><br>" + islamMenu + "<br><br><a href=\"#menu\" class=\"button skyBlueButton\">Top</a>";
